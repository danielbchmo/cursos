...
if ($_POST) {
    ...
    //Tiempo para colocar la fecha de subida con el nombre de la imagen
    $fecha = new DateTime();
    $imagen = $fecha->getTimestamp() . "_" . $_FILES['archivo']['name'];

    //Adjuntar imagenes
    $imagen_temporal = $_FILES['archivo']['tmp_name'];
    move_uploaded_file($imagen_temporal, "imagenes/" . $imagen); //guardar la imagenes en la carpeta imagenes
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="portafolio.php" method="post" enctype="multipart/form-data">
                        <!--multipart/form-data recepciona datos-->
